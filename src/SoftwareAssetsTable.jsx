...
import {
    ...
    useFetchSoftwareAssets,
    useUpdateSoftwareAssets
} from "./querySoftwareAsset.js";
import {
...
const SoftwareAssetsTable = () => {
    const {data, isLoading, isError} = useFetchSoftwareAssets();
    ...
    const mutationPost = useCreateSoftwareAssets()
    const mutationDelete = useDeleteSoftwareAssets()
    const mutationPut = useUpdateSoftwareAssets()
